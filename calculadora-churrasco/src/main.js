...
const calcularChurrasco = () => {
    ...
    document.getElementById("total-carne").innerHTML = `${getValueMeasure(totalCarne, 1)} de carnes`
    document.getElementById("total-pessoas").innerHTML = `${totalPessoas} pessoas no total`
    document.getElementById("total-acompanhamento").innerHTML = `${getValueMeasure(totalAcompanhamento, 1)} de acompanhamentos`
    document.getElementById("total-bebidas-nao-alcoolicas").innerHTML = `${getValueMeasure(totalBebidasNaoAlcoolicas, 2)} de bebidas não alcoolicas`
    document.getElementById("total-bebidas-alcoolicas").innerHTML = `${getValueMeasure(totalBebidasAlcoolicas, 2)} de bebidas alcoolicas`
